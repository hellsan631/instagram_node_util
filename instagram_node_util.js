...
program
  ...
  .option('-t, --text_output [text_output]', "list of csv files, comma separated, output CSV file with text training data", false)
  ...
  .option('-w, --write_frequency', "Sample count to dump csv file..", 3000)
  .parse(process.argv)
