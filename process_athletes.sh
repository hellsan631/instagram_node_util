...
node instagram_node_util --write_frequency=50 --accountnames --customimport ./athlete_data/rugby.csv --outputdir datarugby
# to process:
node instagram_node_util --write_frequency=50 --accountnames --customimport ./athlete_data/tennis_men.csv --outputdir data_tennis_men
